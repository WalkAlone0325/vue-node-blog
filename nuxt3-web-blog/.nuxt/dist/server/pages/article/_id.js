...
module.exports.__inject__ = function (context) {
  add("1f3b74c4", content, true, context)
};
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(4).default("c68e189c", content, true)
...
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".hljs{display:block;overflow-x:auto;padding:.5em;color:#abb2bf;background:#282c34}.hljs-comment,.hljs-quote{color:#5c6370;font-style:italic}.hljs-doctag,.hljs-formula,.hljs-keyword{color:#c678dd}.hljs-deletion,.hljs-name,.hljs-section,.hljs-selector-tag,.hljs-subst{color:#e06c75}.hljs-literal{color:#56b6c2}.hljs-addition,.hljs-attribute,.hljs-meta-string,.hljs-regexp,.hljs-string{color:#98c379}.hljs-built_in,.hljs-class .hljs-title{color:#e6c07b}.hljs-attr,.hljs-number,.hljs-selector-attr,.hljs-selector-class,.hljs-selector-pseudo,.hljs-template-variable,.hljs-type,.hljs-variable{color:#d19a66}.hljs-bullet,.hljs-link,.hljs-meta,.hljs-selector-id,.hljs-symbol,.hljs-title{color:#61aeee}.hljs-emphasis{font-style:italic}.hljs-strong{font-weight:700}.hljs-link{text-decoration:underline}", ""]);
// Exports
...
if(typeof content === 'string') content = [[module.i, content, '']];
if(content.locals) module.exports = content.locals;
__webpack_require__(4).default("6158841e", content, true)
...
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(103);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_8_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_8_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_8_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_8_oneOf_1_3_node_modules_nuxt_components_dist_loader_js_ref_1_0_node_modules_vue_loader_lib_index_js_vue_loader_options_id_vue_vue_type_style_index_0_lang_scss___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_EXPORT___ = ___CSS_LOADER_API_IMPORT___(false);
// Module
___CSS_LOADER_EXPORT___.push([module.i, ".detail-page{margin:0 auto}.detail-page .detail-header{display:flex;justify-content:center;align-items:center;flex-direction:column;height:400px}.detail-page .detail-header h1{color:#fff}.detail-page .detail-header .detail-avatar{margin:10px;color:#fff;font-size:18px}.detail-page .detail-header .detail-avatar .fa-user{margin-right:10px}.detail-page .detail-header .detail-avatar .detail-tag{margin:0 10px}.detail-page .detail-header .detail-date{color:#fff}.detail-page .detail-body{display:flex;justify-content:space-between;align-items:flex-start;width:84%;margin:20px auto}.detail-page .detail-body .detail-left{width:80%}.detail-page .detail-body .detail-left .markdown-body{min-height:600px;padding:50px 40px 20px}.detail-page .detail-body .detail-aside{position:sticky;top:70px;width:20%;margin-left:10px;min-height:200px;background:#fff}.detail-page .detail-body .detail-aside h3{text-align:center;margin:10px auto;padding-bottom:5px;border-bottom:2px solid #8e44ad}.detail-page .detail-body .detail-aside .detail-toc ul{list-style:none}.detail-page .detail-body .detail-aside .detail-toc ul li{margin:0 0 4px -30px;padding:2px 0;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.detail-page .detail-body .detail-aside .detail-toc ul li a{text-decoration:none;color:#333;font-size:14px}.detail-page .detail-body .detail-aside .detail-toc ul li a:hover{border-bottom:2px solid #0ff}.anchor-fix{display:block;height:60px;margin-top:-60px;visibility:hidden}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/_id.vue?vue&type=template&id=eda652f4&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"detail-page"},[_vm._ssrNode("<div class=\"detail-header bg-img-ani\"><h1>"+_vm._ssrEscape(_vm._s(_vm.articleItem.title))+"</h1> <span class=\"detail-avatar\">"+_vm._ssrEscape("作者："+_vm._s(_vm.articleItem.avatar))+"</span> <span class=\"detail-avatar\">"+(_vm._ssrList((_vm.articleItem.tags),function(item){return ("<span><span class=\"detail-tag\">"+_vm._ssrEscape("标签："+_vm._s(item.tag))+"</span></span>")}))+"</span> <span class=\"detail-date\">"+_vm._ssrEscape("发布时间："+_vm._s(_vm.time))+"</span></div> "),_vm._ssrNode("<div class=\"detail-body\">","</div>",[_vm._ssrNode("<div class=\"detail-left\">","</div>",[_vm._ssrNode("<div class=\"markdown-body\">","</div>",[(!_vm.articleItem.body)?_c('loading'):_c('div',{ref:"content",domProps:{"innerHTML":_vm._s(_vm.code)}})],1)]),_vm._ssrNode(" <div class=\"detail-aside\"><h3>目录</h3> "+((!_vm.articleItem.toc)?("<div>亲，正在加载中。。。</div>"):("<div class=\"detail-toc\">"+(_vm._s(_vm.toc))+"</div>"))+"</div>")],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/article/_id.vue?vue&type=template&id=eda652f4&
...
var external_marked_ = __webpack_require__(81);
var external_marked_default = /*#__PURE__*/__webpack_require__.n(external_marked_);

// EXTERNAL MODULE: external "highlight.js"
var external_highlight_js_ = __webpack_require__(82);

// CONCATENATED MODULE: ./compositions/usetitle.ts
...
const useTitle = content => {
  ...
  external_marked_default.a.setOptions({
    ...
    highlight(code) {
      return Object(external_highlight_js_["highlightAuto"])(code).value;
    },
...
var atom_one_dark = __webpack_require__(114);

// EXTERNAL MODULE: ./assets/css/_highlight.scss
var _highlight = __webpack_require__(116);
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--13-0!./node_modules/ts-loader??ref--13-1!./node_modules/@nuxt/components/dist/loader.js??ref--1-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/article/_id.vue?vue&type=script&lang=ts&
...
/* harmony default export */ var _idvue_type_script_lang_ts_ = ({
  name: 'ArticleDetail',
  components: {
  ...
  setup() {
    const articleItem = Object(dist["ref"])({});
    const code = Object(dist["ref"])('');
    const toc = Object(dist["ref"])('');
    const {
      $axios,
      params
    } = Object(dist["useContext"])();
    Object(dist["onMounted"])(() => {
      $axios.get(`article/${params.value.id}`).then(res => {
        if (res.status === 200) {
    ...
    const time = Object(dist["computed"])(() => {
      return Object(timeFormat["a" /* timeFormat */])(articleItem.value.created);
    });
    return {
      articleItem,
      code,
...
// CONCATENATED MODULE: ./pages/article/_id.vue?vue&type=script&lang=ts&
 /* harmony default export */ var article_idvue_type_script_lang_ts_ = (_idvue_type_script_lang_ts_); 
...
var component = Object(componentNormalizer["a" /* default */])(
  article_idvue_type_script_lang_ts_,
  render,
  staticRenderFns,
  false,
  injectStyles,
...
installComponents(component, {Loading: __webpack_require__(84).default})
